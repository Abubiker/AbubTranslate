...
/// российских IP на уровне сети (не только оплату) — без VPN не заработает
/// вообще, ключ тут не при чём. Пользователь в курсе, решил добавить всё
/// равно — риск и ответственность на нём, тот же принцип, что для
/// остальных облачных движков.
///
