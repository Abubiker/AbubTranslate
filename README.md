...
| DeepL | облако | нужен API-ключ: developers.deepl.com, бесплатный тир 500 000 символов/месяц; ⚠️ **сам блокирует запросы с российских IP на уровне сети** — без VPN ключ не поможет |
...
4. Бесплатный лимит — 500 000 символов/месяц.
5. ⚠️ **DeepL сам блокирует запросы с российских IP на уровне сети** (не
   только оплату) — без VPN ключ работать не будет вообще, это не баг
   приложения.
