...
единственный найденный источник готовых CoreML-моделей перевода
(`coreml-community` на HuggingFace) не содержит ни одной такой модели —
организация существует, но публикует только конвертации Stable Diffusion.
Раньше в приложении был режим Local OPUS, качавший модели именно оттуда —
убран целиком, ни одна закачка не могла завершиться успехом.
